...
function [mnet, lfactors,clustering,cscores] = som_lfmat(ulocs,ratings,lfindex,popindex,dim1,dim2, display) 

% INPUTS: ulocs is an Nx2 aray of user locations; ratings contains an Nxm array of N users and m movies, either
...
% run the self-organizing network to cluster the users  by location 
[mnet, clustering, mout] = movie_user_som(ulocs,dim1,dim2, display); 
